...
/**
 * This class represents a start point that denotes the beginning of the level.
 * 
...
{
  /**
   * Creates a new oriented start point at the specified location.
   * 
   * @param x the x position of the start point
   * @param y the y position of the start point
   * @param z the z position of the start point
   ...
   * @param orientation the cardinal direction of the start point
   * @param trap an optional trap to place on the start point
   */
  public Start(float x, float y, float z, String groundTexture, String wallTexture, Direction orientation, TrapType type)
  {
