  ...
  public Corridor(float x, float y, float z, String groundTexture, String wallTexture, Direction orientation, TrapType type)
  {
    ...
    switch (orientation)
    {
      case NORTH:
      {
        ...
        components.add(new InvisibleWall(x, y + 10.0f, z + (size / 2), null, size, 10.0f, 0f));
      ...
      case EAST:
      {
        ...
        components.add(new InvisibleWall(x + (size / 2), y + 10.0f, z, null, 0.0f, 10.0f, size));
      ...
      case SOUTH:
      {
        ...
        components.add(new RectangularPrism(x, y + 1.5f, z + (size / 2), wallTexture, size, 3.0f, 1.0f));
        components.add(new InvisibleWall(x, y + 10.0f, z + (size / 2), null, size, 10.0f, 0.0f));
