...
public class Shader
{
  ...
  private static class CompileLinkShaderException extends RuntimeException
  {
    ...
    {
      super(glGetShaderInfoLog(shader, glGetShaderi(shader, GL_INFO_LOG_LENGTH)));
    }
  }
  ...
  private static class CompileLinkProgramException extends RuntimeException
  {
    ...
    {
      super(glGetShaderInfoLog(program, glGetShaderi(program, GL_INFO_LOG_LENGTH)));
    }
  }
}
